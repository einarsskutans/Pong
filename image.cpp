...
Image::Image(int px, int py, int pvelx, int pvely, int psizex, int psizey, Color pcolor, bool pmovable, ALLEGRO_BITMAP *pplayer) {
...
void Image::Draw() {
    al_draw_bitmap(player, pos.x, pos.y, 0);
}